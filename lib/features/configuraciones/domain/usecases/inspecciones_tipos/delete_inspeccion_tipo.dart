...
class DeleteInspeccionTipoUseCase implements UseCase<DataState<ApiResponse>, InspeccionTipoReqEntity> {
  ...
  @override
  Future<DataState<ApiResponse>> call(InspeccionTipoReqEntity idInspeccionTipo) async {
    return _inspeccionTipoRepository.deleteInspeccionTipo(idInspeccionTipo);
  }
}
