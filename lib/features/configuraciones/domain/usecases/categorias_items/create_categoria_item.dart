...
class CreateCategoriaItemUseCase implements UseCase<DataState<ApiResponseEntity>, CategoriaReqEntity> {
  CreateCategoriaItemUseCase(this._categoriaRepository);
