...
class CreateInspeccionUseCase implements UseCase<DataState<ApiResponseEntity>, InspeccionEntity>{
  CreateInspeccionUseCase(this._inspeccionRepository);

  final InspeccionRepository _inspeccionRepository;

  @override
  Future<DataState<ApiResponseEntity>> call({InspeccionEntity? params}) {
