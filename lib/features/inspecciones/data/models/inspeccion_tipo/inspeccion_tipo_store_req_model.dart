...
///
/// Representa el modelo de la información para crear un tipo de inspección, su propósito es transportar
...
class InspeccionTipoStoreReqModel extends InspeccionTipoStoreReqEntity {
  ...
  factory InspeccionTipoStoreReqModel.fromJson(Map<String, dynamic> jsonMap) {
    return InspeccionTipoStoreReqModel( codigo: jsonMap['codigo'] as String, name: jsonMap['name'] as String);
  }
  ...
  factory InspeccionTipoStoreReqModel.fromEntity(InspeccionTipoStoreReqEntity entity) {
    return InspeccionTipoStoreReqModel(codigo: entity.codigo, name: entity.name);
  }

  /// Serialización de la estructura del modelo a formato JSON.
  Map<String, dynamic> toJson() {
    return <String, dynamic>{ 'codigo': codigo, 'name': name };
  }
}
