...
///
/// Representa el modelo de la información para evaluar una unidad, su propósito es transportar
...
class InspeccionCategoriaStoreReqModel extends InspeccionCategoriaStoreReqEntity {
  const InspeccionCategoriaStoreReqModel({
    ...
    required List<InspeccionCategoria> categorias,
  }) : super(
  ...
  /// Constructor factory para convertir la instancia de [InspeccionCategoriaStoreReqEntity]
