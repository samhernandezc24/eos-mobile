...
/// [InspeccionModel]
///
/// Representa el modelo de la información general de una inspección.
class InspeccionModel extends InspeccionEntity {
  ...
  /// Constructor factory para crear la instancia de [InspeccionModel]
  /// durante el mapeo del JSON.
  factory InspeccionModel.fromJson(Map<String, dynamic> jsonMap) {
    return InspeccionModel(
      ...
      capacidad                     : jsonMap['capacidad'] as String? ?? '0.000',
  ...
  /// Constructor factory para convertir la instancia de [InspeccionEntity]
  /// en una instancia de [InspeccionModel].
