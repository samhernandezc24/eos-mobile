...
/// [UnidadPredictiveModel]
///
/// Representa la lista predictiva de unidades (temporales) para realizar operaciones de
/// búsqueda o autocompletado.
class UnidadPredictiveModel extends UnidadPredictiveEntity {
  const UnidadPredictiveModel({
  ...
  /// Constructor factory para crear la instancia de [UnidadPredictiveModel]
  /// durante el mapeo del JSON.
  factory UnidadPredictiveModel.fromJson(Map<String, dynamic> jsonMap) {
    return UnidadPredictiveModel(
  ...
  /// Constructor factory para convertir la instancia de [UnidadPredictiveEntity]
  /// en una instancia de [UnidadPredictiveModel].
  factory UnidadPredictiveModel.fromEntity(UnidadPredictiveEntity entity) {
    return UnidadPredictiveModel(
