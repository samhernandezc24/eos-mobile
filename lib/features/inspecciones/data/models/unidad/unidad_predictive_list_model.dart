...
class UnidadPredictiveListModel extends UnidadPredictiveListEntity {
  ...
  factory UnidadPredictiveListModel.fromJson(Map<String, dynamic> jsonMap) {
    return UnidadPredictiveListModel(
      ...
      idUnidadMarca             : jsonMap['idUnidadMarca'] as String == '' || jsonMap['idUnidadMarca'] == null ? null : jsonMap['idUnidadMarca'] as String,
      unidadMarcaName           : jsonMap['unidadMarcaName'] as String == '' || jsonMap['unidadMarcaName'] == null ? null : jsonMap['unidadMarcaName'] as String,
      idUnidadPlacaTipo         : jsonMap['idUnidadPlacaTipo'] as String == '' || jsonMap['idUnidadPlacaTipo'] == null ? null : jsonMap['idUnidadPlacaTipo'] as String,
      unidadPlacaTipoName       : jsonMap['unidadPlacaTipoName'] as String == '' || jsonMap['unidadPlacaTipoName'] == null ? null : jsonMap['unidadPlacaTipoName'] as String,
      placa                     : jsonMap['placa'] as String == '' || jsonMap['placa'] == null ? null : jsonMap['placa'] as String,
      modelo                    : jsonMap['modelo'] as String? ?? '',
      anioEquipo                : jsonMap['anioEquipo'] as String? ?? '',
      capacidad                 : jsonMap['capacidad'] as String? ?? '',
      idUnidadCapacidadMedida   : jsonMap['idUnidadCapacidadMedida'] == '' || jsonMap['idUnidadCapacidadMedida'] == null ? null : jsonMap['idUnidadCapacidadMedida'] as String,
      unidadCapacidadMedidaName : jsonMap['unidadCapacidadMedidaName'] == '' || jsonMap['unidadCapacidadMedidaName'] == null ? null : jsonMap['unidadCapacidadMedidaName'] as String,
