...
class UnidadModel extends UnidadEntity {
  ...
  factory UnidadModel.fromJson(Map<String, dynamic> jsonMap) {
    return UnidadModel(
      ...
      idBase                      : jsonMap['idBase'] == '' || jsonMap['idBase'] == null ? null : jsonMap['idBase'] as String,
      baseName                    : jsonMap['baseName'] == '' || jsonMap['baseName'] == null ? null : jsonMap['baseName'] as String,
      idUnidadTipo                : jsonMap['idUnidadTipo'] as String,
      unidadTipoName              : jsonMap['unidadTipoName'] as String,
      idUnidadMarca               : jsonMap['idUnidadMarca'] == '' || jsonMap['idUnidadMarca'] == null ? null : jsonMap['idUnidadMarca'] as String,
      unidadMarcaName             : jsonMap['unidadMarcaName'] == '' || jsonMap['unidadMarcaName'] == null ? null : jsonMap['unidadMarcaName'] as String,
      idUnidadPlacaTipo           : jsonMap['idUnidadPlacaTipo'] == '' || jsonMap['idUnidadPlacaTipo'] == null ? null : jsonMap['idUnidadPlacaTipo'] as String,
      unidadPlacaTipoName         : jsonMap['unidadPlacaTipoName'] == '' || jsonMap['unidadPlacaTipoName'] == null ? null : jsonMap['unidadPlacaTipoName'] as String,
      placa                       : jsonMap['placa'] == '' || jsonMap['placa'] == null ? null : jsonMap['placa'] as String,
