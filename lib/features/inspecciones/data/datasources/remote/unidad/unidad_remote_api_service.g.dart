...
part of 'unidad_remote_api_service.dart';
...
class _UnidadRemoteApiService implements UnidadRemoteApiService {
  _UnidadRemoteApiService(
    this._dio, {
    this.baseUrl,
  }) {
