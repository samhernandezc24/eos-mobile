...
/// [RemoteFinishInspeccionUseCase]
class FinishInspeccion extends RemoteInspeccionEvent {
  const FinishInspeccion(this.objData);

  final InspeccionFinishReqEntity objData;
