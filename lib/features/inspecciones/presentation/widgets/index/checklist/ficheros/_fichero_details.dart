...
class _FicheroDetails extends StatefulWidget {
  const _FicheroDetails({required this.lstFicheros, required this.initialIndex, Key? key}) : super(key: key);

  final List<Fichero> lstFicheros;
  final int initialIndex;

  @override
  State<_FicheroDetails> createState() => _FicheroDetailsState();
}

class _FicheroDetailsState extends State<_FicheroDetails> {
  // CONTROLLERS
      ...
      body: PhotoViewGallery.builder(
        ...
        builder               : (BuildContext context, int index) {
          return PhotoViewGalleryPageOptions(
            imageProvider   : NetworkImage(ApiEndpoints.inspeccionFicheroPath(widget.lstFicheros[index].path ?? '')),
