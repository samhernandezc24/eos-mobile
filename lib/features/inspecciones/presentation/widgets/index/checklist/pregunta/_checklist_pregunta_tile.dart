...
class _ChecklistInspeccionPreguntaTile extends StatefulWidget {
  const _ChecklistInspeccionPreguntaTile({
  ...
  final InspeccionCategoria categoria;
  final bool? evaluado;
  final void Function(int, InspeccionCategoriaValue) onChange;

  @override
  State<_ChecklistInspeccionPreguntaTile> createState() => _ChecklistInspeccionPreguntaTileState();
}

class _ChecklistInspeccionPreguntaTileState extends State<_ChecklistInspeccionPreguntaTile> {
  // PROPERTIES
  late List<InspeccionCategoriaValue> lstCategoriasItems;
  ...
  void _updateItemValue(int index, String newValue) {
    setState(() {
      final InspeccionCategoriaValue item  = lstCategoriasItems[index];
  ...
  void _applyMassOptionChange(String option) {
    setState(() {
      ...
      for (int index = 0; index < lstCategoriasItems.length; index++) {
        ...
        InspeccionCategoriaValue updatedItem = item.copyWith(value: option);
  ...
  void _notifyChange(int index) {
    final InspeccionCategoriaValue updatedItem = lstCategoriasItems[index];
    widget.onChange(index, updatedItem);
  }
  ...
  Widget _buildFormularioTipo(InspeccionCategoriaValue item, int index, bool noAplica) {
