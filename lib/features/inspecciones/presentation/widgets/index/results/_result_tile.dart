...
class _ResultInspeccionTile extends StatelessWidget {
  const _ResultInspeccionTile({
    Key? key,
    this.objInspeccion,
  ...
  Widget _buildInspeccionInfo(BuildContext context, InspeccionEntity objInspeccion) {
    return Expanded(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
  ...
  Widget _buildInspeccionEstatus(BuildContext context, InspeccionEntity objInspeccion) {
