...
class _SearchUnidadEOSInput extends StatefulWidget {
  ...
  final List<UnidadEOSPredictiveEntity> results;
  final void Function(UnidadEOSPredictiveEntity) onSelected;
...
class _SearchUnidadEOSInputState extends State<_SearchUnidadEOSInput> {
  // PROPERTIES
  ...
  Widget _buildSuggestionsView(BuildContext context, void Function(UnidadEOSPredictiveEntity) onSelected, List<UnidadEOSPredictiveEntity> results, BoxConstraints constraints) {
  ...
  Widget _buildSuggestion(BuildContext context, UnidadEOSPredictiveEntity suggestion, VoidCallback onPressed) {
