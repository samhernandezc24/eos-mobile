...
class _SearchUnidadInput extends StatefulWidget {
  ...
  final List<UnidadPredictiveEntity> results;
  final void Function(UnidadPredictiveEntity) onSelected;
  ...
  @override
  State<_SearchUnidadInput> createState() => _SearchUnidadInputState();
}

class _SearchUnidadInputState extends State<_SearchUnidadInput> {
  // PROPERTIES
  ...
  Widget _buildSuggestionsView(BuildContext context, void Function(UnidadPredictiveEntity) onSelected, List<UnidadPredictiveEntity> results, BoxConstraints constraints) {
    ...
    return Container(
      ...
      child: CenterLeft(
        child: DefaultTextStyle(
          ...
          child: Text(
            AppStrings.searchInputTitleSuggestions.toUpperCase(),
  ...
  Widget _buildSuggestion(BuildContext context, UnidadPredictiveEntity suggestion, VoidCallback onPressed) {
