...
class _SearchUnidadEOS extends StatelessWidget {
  ...
  final List<UnidadEOSPredictiveListEntity> lstRows;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (ctx, constraints) => Center(
        child: PredictiveSearchField<UnidadEOSPredictiveListEntity>(
          options: lstRows,
