...
mixin ThrottledSaveLoadMixin {
  ...
  Future<void> load() async {
    ...
    } on Exception catch (ex) { debugPrint(ex.toString()); }
  }

  /// Evento que se encarga de guardar los datos en el archivo local.
  ///
  ...
  /// Evento que se encarga de programar el guardado de datos utilizando el `_throttle`.
  ///
  /// Esto asegura que múltiples callbacks `scheduleSave()` dentro de un corto periodo
