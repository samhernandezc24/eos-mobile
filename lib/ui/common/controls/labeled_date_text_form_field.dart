...
class LabeledDateTextFormField extends StatelessWidget {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        ValueListenableBuilder(
          ...
          builder         : (_, value, __) {
            return Visibility(
              visible : FormValidators.dateTextValidator(controller.text) != null,
              child   : Text(
                '* ${FormValidators.dateTextValidator(controller.text) ?? ''}',
