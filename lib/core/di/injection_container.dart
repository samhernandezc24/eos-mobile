...
Future<void> initializeDependencies() async {
  ...
  ..registerSingleton<FetchCategoriaByIdInspeccionTipoUseCase>(FetchCategoriaByIdInspeccionTipoUseCase(sl()))
  ...
  ..registerFactory<RemoteCategoriaBloc>(() => RemoteCategoriaBloc(sl()));
}
